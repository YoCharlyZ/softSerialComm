...
const uint8_t softRX = 4; // Uno PinD4(softRX) 
const uint8_t softTX = 2; // Uno PinD2(softTX) 
...
const uint8_t mySlaveID = 8; // Mi adressID de Esclavo
const uint8_t toMasterID = 10; // El adressID de al menos un Maestro Uno
